...
class SimAdapter(private var simList : ArrayList<SimData>) : RecyclerView.Adapter<SimAdapter.MyViewHolder> () {
    ...
    inner  class MyViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        val showQrCode : Button = itemView.findViewById(com.example.myandroidapp.R.id.showQrCode)
        val hideQrCode : Button = itemView.findViewById(com.example.myandroidapp.R.id.hideQrCode)
